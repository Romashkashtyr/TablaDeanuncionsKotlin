package com.example.tabladeanuncionskotlin.utils
...
object CityHelper {
    ...
    fun filterListData(list: ArrayList<String>, searchView: String?): ArrayList<String>{
        ...
        for(selection: String in list){
            if(selection.lowercase(Locale.ROOT).startsWith(searchView.lowercase(Locale.ROOT))){
